...
sleep 2
xterm  -e  " source ~/Udacity-Robotics-ND/Home-Service-Robot/catkin_ws/devel/setup.bash; roslaunch turtlebot_gazebo gmapping_demo.launch" &
sleep 2
xterm  -e  " source ~/Udacity-Robotics-ND/Home-Service-Robot/catkin_ws/devel/setup.bash; roslaunch turtlebot_rviz_launchers view_teleop_navigation.launch" 